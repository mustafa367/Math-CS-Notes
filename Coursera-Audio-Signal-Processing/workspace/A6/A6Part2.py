...
if __name__=="__main__":
    print(segmentStableNotesRegions(inputFile='../../sounds/cello-phrase.wav', stdThsld=10, 
                                    minNoteDur=0.1, winStable = 3, window='hamming', M=1025, N=2048, H=256, f0et=5.0, 
                                    t=-100, minf0=310, maxf0=650))    
    print(segmentStableNotesRegions(inputFile='../../sounds/cello-phrase.wav', stdThsld=20,
                                    minNoteDur=0.5, winStable = 3, window='hamming', M=1025, N=2048, H=256, f0et=5.0,
                                    t=-100, minf0=310, maxf0=650))
    print(segmentStableNotesRegions(inputFile='../../sounds/sax-phrase-short.wav', stdThsld=5, 
